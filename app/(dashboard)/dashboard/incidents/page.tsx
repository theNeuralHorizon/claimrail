...
export default async function IncidentsPage() {
  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-ink-900 dark:text-ink-100">Incidents</h1>
                    ...
                    const tone =
                      i.severity === 'critical'
                        ...
                        : i.severity === 'major'
                          ...
                          : 'info';
                    return (
                      <tr key={i.id} className="hover:bg-ink-50/60 dark:hover:bg-ink-800/40">
                        ...
                        <td className="px-6 py-3 text-ink-700 dark:text-ink-300 max-w-md truncate">
                          {i.summary}
                        </td>
                      </tr>
                    );
